...
class MyWidget(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # set -> fijar, setear, asignar un valor 
        # get -> recuperar, obtener
        ...
        self.volume_slider1.setValue(self.volume)
        ...
        self.volume_slider2.setValue(self.speed)
    ...
    def on_gender_select_changed(self, index):
        self.gender_voice = self.gender_select.currentText()
        print("Selected gender:", self.gender_voice)

    def on_play_button_click(self):
        text_input_value = self.text_input.toPlainText()
        # print("Text input value:", text_input_value)
        cadena = f"""
        volume: {self.volume}
        speed:  {self.speed} 
        voice_gender: {self.gender_voice}
        texto: {text_input_value}
        """
        print(cadena)
